...
<head>
	...
	<title>ReadableBodyStreamReader | @fastly/as-compute - v0.2.0</title>
		...
		<li class="current tsd-kind-class tsd-parent-kind-module tsd-is-external">
			...
			<ul>
				<li class=" tsd-kind-get-signature tsd-parent-kind-class tsd-is-external">
					<a href="_fastly_.readablebodystreamreader.html#closed" class="tsd-kind-icon">closed</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="_fastly_.readablebodystreamreader.html#read" class="tsd-kind-icon">read</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="_fastly_.readablebodystreamreader.html#readall" class="tsd-kind-icon">read<wbr>All</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="_fastly_.readablebodystreamreader.html#releaselock" class="tsd-kind-icon">release<wbr>Lock</a>
				</li>
			</ul>
		</li>
		<li class=" tsd-kind-class tsd-parent-kind-module tsd-is-external">
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Reader to a readable stream to an HTTP Request/Response Body. This is similar to
					the <a href="https://developer.mozilla.org/en-US/docs/Web/API/ReadableStreamDefaultReader">Streams API&#39;s ReadableStreamDefaultReader</a></p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">ReadableBodyStreamReader</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-get-signature tsd-parent-kind-class tsd-is-external"><a href="_fastly_.readablebodystreamreader.html#closed" class="tsd-kind-icon">closed</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="_fastly_.readablebodystreamreader.html#read" class="tsd-kind-icon">read</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="_fastly_.readablebodystreamreader.html#readall" class="tsd-kind-icon">read<wbr>All</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="_fastly_.readablebodystreamreader.html#releaselock" class="tsd-kind-icon">release<wbr>Lock</a></li>
						</ul>
					</section>
				</div>
			</section>
			...
			<section class="tsd-panel tsd-member tsd-kind-get-signature tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Getter for if the reader is closed.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4>
						<p>true if the reader is closed, false if not.</p>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">read<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="_fastly_.readresponse.html" class="tsd-signature-type">ReadResponse</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Read a chunk from the Body stream.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <a href="_fastly_.readresponse.html" class="tsd-signature-type">ReadResponse</a></h4>
						<p>ReadResponse where the <code>value</code> property contains the read chunk as an <code>ArrayBuffer</code>, and the <code>done</code> property which is true if we read the entire stream.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<h3>read<wbr>All</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">read<wbr>All<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ArrayBuffer</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Continually read the stream of the body until is it completed.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">ArrayBuffer</span></h4>
						<p>an <code>ArrayBuffer</code> of the entire streamed Body Content</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Release the lock on the associated ReadableStream that created this reader
								After releasing the lock, this reader instance is closed.</p>
							</div>
						</div>
