...
<head>
	...
	<title>WriteableBodyStreamWriter | @fastly/as-compute - v0.2.0</title>
		...
		<li class="current tsd-kind-class tsd-parent-kind-module tsd-is-external">
			...
			<ul>
				<li class=" tsd-kind-get-signature tsd-parent-kind-class tsd-is-external">
					<a href="_fastly_.writeablebodystreamwriter.html#closed" class="tsd-kind-icon">closed</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="_fastly_.writeablebodystreamwriter.html#close" class="tsd-kind-icon">close</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="_fastly_.writeablebodystreamwriter.html#releaselock" class="tsd-kind-icon">release<wbr>Lock</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="_fastly_.writeablebodystreamwriter.html#write" class="tsd-kind-icon">write</a>
				</li>
			</ul>
		</li>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Writer to a writeable stream of an HTTP Request/Response Body. This is similar to
					the <a href="https://developer.mozilla.org/en-US/docs/Web/API/WritableStreamDefaultWriter">Streams API&#39;s WriteableStreamDefaultReader</a></p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">WriteableBodyStreamWriter</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-get-signature tsd-parent-kind-class tsd-is-external"><a href="_fastly_.writeablebodystreamwriter.html#closed" class="tsd-kind-icon">closed</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="_fastly_.writeablebodystreamwriter.html#close" class="tsd-kind-icon">close</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="_fastly_.writeablebodystreamwriter.html#releaselock" class="tsd-kind-icon">release<wbr>Lock</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="_fastly_.writeablebodystreamwriter.html#write" class="tsd-kind-icon">write</a></li>
						</ul>
					</section>
				</div>
			</section>
			...
			<section class="tsd-panel tsd-member tsd-kind-get-signature tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Getter for if the writer is closed.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4>
						<p>true if the writer is closed, false if not.</p>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Close the writer and the body.
								This will signify that the streaming is completed.</p>
							</div>
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Release the lock on the associated WriteableStream that created this writer
								After releasing the lock, this writer instance is closed.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<h3>write</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">write<span class="tsd-signature-symbol">(</span>responseBodyBuffer<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ArrayBuffer</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Write a buffer to the body stream.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>responseBodyBuffer: <span class="tsd-signature-type">ArrayBuffer</span></h5>
								<div class="tsd-comment tsd-typography">
									<p><code>ArrayBuffer</code> that should be written to the Body Stream.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
