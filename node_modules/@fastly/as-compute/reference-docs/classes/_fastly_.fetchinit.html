...
<head>
	...
	<title>FetchInit | @fastly/as-compute - v0.2.0</title>
		...
		<li class="current tsd-kind-class tsd-parent-kind-module tsd-is-external">
			...
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="_fastly_.fetchinit.html#backend" class="tsd-kind-icon">backend</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="_fastly_.fetchinit.html#cacheoverride" class="tsd-kind-icon">cache<wbr>Override</a>
				</li>
			</ul>
		</li>
		<li class=" tsd-kind-class tsd-parent-kind-module tsd-is-external">
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>The configuration object to apply to the Fetch.</p>
				</div>
				<p>Similar to the <a href="https://developer.mozilla.org/en-US/docs/Web/API/WindowOrWorkerGlobalScope/fetch#Parameters">Fetch API</a>,
				the parameters here will be applied to the <code>as-fetch</code> <a href="request.html"><code>Request</code></a> being sent in the <code>fetch</code> call.</p>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">FetchInit</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="_fastly_.fetchinit.html#backend" class="tsd-kind-icon">backend</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="_fastly_.fetchinit.html#cacheoverride" class="tsd-kind-icon">cache<wbr>Override</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The backend the request should be sent to.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				<a name="cacheoverride" class="tsd-anchor"></a>
				<h3>cache<wbr>Override</h3>
				<div class="tsd-signature tsd-kind-icon">cache<wbr>Override<span class="tsd-signature-symbol">:</span> <a href="_fastly_.cacheoverride.html" class="tsd-signature-type">CacheOverride</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">null</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>An optional CacheOverride to applied to the request.</p>
					</div>
				</div>
			</section>
		</section>
